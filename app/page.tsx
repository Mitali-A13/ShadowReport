      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-zinc-400">
            Make your community safer without compromising your safety. The system is designed with basic privacy principles to help protect sensitive information during submission.
          </p>
          ...
          {[
            {
              ...
              description:
                "Your information is handled securely within this demo environment using standard web practices. (This prototype does not offer production-level encryption)",
              icon: (
                <svg
            ...
            },
            {
              ...
              description: "This prototype simulates how a user might receive updates or responses in a real system. (Actual law enforcement integration is not included)",
              icon: (
                <svg
                  className="h-6 w-6 text-sky-400"
                  fill="none"
        ...
        <div className="mt-40 mb-20 flex justify-center">
          <div className="inline-flex items-center gap-3 rounded-full bg-zinc-900 px-5 py-2 text-sm text-zinc-400">
            ...
            Built as an Educational Prototype
          </div>
        </div>
      </div>
    </main>
